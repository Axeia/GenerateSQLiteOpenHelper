 ...
 * Greatly simplifies 
 */
class GenerateSQLiteOpenHelper
{
    /** Name of the generated class */
    private $className = ''; 
    /** Name of the database, e.g. how it gets stored on the android device. */
    private $databaseName = '';
    /** The indentation used in the output code. */
    private $indentation = '    ';
    /** Just out of convenience so we don't we need to type this all the time */
    private $strPrivStatic = 'private static final String ';
    /** */
    private $tableNamesCode = '';
    private $columnNamesCode = '';
    ...
    /**
     * Multi dimensional aaray structured as follows:
     * 'table_name' => 
     ...
     */
    function GenerateSQLiteOpenHelper($sql, $className = 'MyAppDbHelper', 
    $databaseName = 'main.sqlite', $identation = '    ')
    {
